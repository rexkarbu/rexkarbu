...
Updated **2026-09-24 (UTC)**. These files show the last successful refresh, not a live feed.

## Public repositories

- **10 public repositories** owned by rexkarbu, including forks and this profile repository.
...
Period: **2025-09-21 through 2026-09-24**, inclusive. The calendar contains **389 contributions across 34 active days**.
...
Rendered with [Platane/snk at the pinned commit](https://github.com/Platane/snk/tree/a041d6c27ba561a39f5be9c26a784812765e434b), using a local adapter for the saved public calendar. The same dates, counts, and levels feed both views.
